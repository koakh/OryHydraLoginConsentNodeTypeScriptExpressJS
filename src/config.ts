...
const i18n = {
  validationMessage: {
    ...
    username: 'must be 9 numeric characters long',
    password: "must have at least 8 character's, one lower, one upper case",
    email: 'must be a valid email',
    phoneNumber: 'must be a valid mobile phone number',
  ...
  messages: {
    ...
    changePasswordSuccessTitle: 'Password changed successfully',
